...
gltfLoader.load('./models.glb', (gltf) => 
{
    ...
    gui
        ...
        .onChange(() => 
        { 
            particles.material.uniforms.uColorA.value.set(new THREE.Color(particles.uColorA)) 
        })
    gui
        .addColor(particles, 'colorB')
        .onChange(() => 
        { 
            particles.material.uniforms.uColorB.value.set(new THREE.Color(particles.uColorB)) 
        })
