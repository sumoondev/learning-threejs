...
import { depthPass } from 'three/src/nodes/display/PassNode.js'
...
const uniforms = {
    ...
    uWrapedPositionFrequency: new THREE.Uniform(0.38),
    uWrapedTimeFrequency: new THREE.Uniform(0.12),
    uWrapedStrength: new THREE.Uniform(1.7),
...
gui.add(uniforms.uWrapedPositionFrequency, 'value', 0, 2, 0.001).name('uWrapedPositionFrequency')
gui.add(uniforms.uWrapedTimeFrequency, 'value', 0, 2, 0.001).name('uWrapedTimeFrequency')
gui.add(uniforms.uWrapedStrength, 'value', 0, 2, 0.001).name('uWrapedStrength')
