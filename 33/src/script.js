...
const portalLightMaterial = new THREE.ShaderMaterial({
    uniforms: {
        ...
        uColorStart: new THREE.Uniform(new THREE.Color(0x000000)),
        uColorEnd: new THREE.Uniform(new THREE.Color(0xffffff)),
    },
...
gui.add(firefliesMaterial.uniforms.uSize, 'value', 0, 500, 1).name('fireflieSize')
